function[Gimme_model_H, Gimme_model_I]=Generation_Gimme_alt(model_Healthy,NHBE_Healthy_mean,essentialTasks_H,Cobra_infected_model,NHBE_Infected_mean,essentialTasks_I)
